            ...
            <g>
                ...
                <g id="planet">
                    ...
                    <path id="ringShadow" opacity="0.5" fill="none" stroke="#0E0620" stroke-width="3"
                        stroke-linecap="round" stroke-miterlimit="10" d="M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                </g>
                <g id="stars">
                    <g id="starsBig">
                        <g>
...
C360.647,451.083,349.251,457.661,338.164,454.689z" />
    ...
    <div class="error-col">
        ...
        <div v-if="error.statusCode == 404">
            ...
            <p>您访问的页面 {{ error.url }} 不存在，点击下方按钮返回首页</p>
        </div>
        <div v-else>
            <h2>{{ error.statusMessage }}</h2>
            <p>{{ error.message }}</p>
        </div>
        <button class="btn green" @click="backHome()">返回首页</button>
    </div>
</div>
</template>
<script setup>
...
onMounted(() => {
    ...
    gsap.to("#headStripe", 
        { y: 0.5, rotation: 1, yoyo: true, repeat: -1, ease: "sine.inOut", duration: 1 }
    );
    gsap.to("#spaceman", 
        { y: 0.5, rotation: 1, yoyo: true, repeat: -1, ease: "sine.inOut", duration: 1 }
    );
    gsap.to("#craterSmall", 
        { x: -3, yoyo: true, repeat: -1, duration: 1, ease: "sine.inOut" }
    );
    gsap.to("#craterBig", 
        { x: 3, yoyo: true, repeat: -1, duration: 1, ease: "sine.inOut" }
    );
    gsap.to("#planet", 
        { rotation: -2, yoyo: true, repeat: -1, duration: 1, ease: "sine.inOut", transformOrigin: "50% 50%" }
    );
    gsap.to("#starsBig g", 
